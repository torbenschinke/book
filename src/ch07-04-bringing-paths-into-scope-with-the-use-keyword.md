...
```rust
{{#include ../listings/ch07-managing-growing-projects/listing-07-11/src/lib.rs}}
# fn main() {}
```
...
```rust
{{#include ../listings/ch07-managing-growing-projects/listing-07-12/src/lib.rs}}
# fn main() {}
```
...
```rust
{{#include ../listings/ch07-managing-growing-projects/listing-07-13/src/lib.rs}}
# fn main() {}
```
...
```rust
{{#include ../listings/ch07-managing-growing-projects/listing-07-14/src/main.rs}}
```
...
```rust
{{#include ../listings/ch07-managing-growing-projects/listing-07-15/src/lib.rs:1:4}}
    // --snip--
#    Ok(())
{{#include ../listings/ch07-managing-growing-projects/listing-07-15/src/lib.rs:6:8}}
    // --snip--
#    Ok(())
{{#include ../listings/ch07-managing-growing-projects/listing-07-15/src/lib.rs:10}}
```
...
```rust
{{#include ../listings/ch07-managing-growing-projects/listing-07-16/src/lib.rs:1:4}}
    // --snip--
#    Ok(())
{{#include ../listings/ch07-managing-growing-projects/listing-07-16/src/lib.rs:6:8}}
    // --snip--
#    Ok(())
{{#include ../listings/ch07-managing-growing-projects/listing-07-16/src/lib.rs:10}}
```
...
```rust
{{#include ../listings/ch07-managing-growing-projects/listing-07-17/src/lib.rs}}
# fn main() {}
```
...
```rust,ignore
{{#include ../listings/ch02-guessing-game-tutorial/listing-02-03/src/main.rs:2:4}}
{{#include ../listings/ch02-guessing-game-tutorial/listing-02-03/src/main.rs:7}}
{{#include ../listings/ch02-guessing-game-tutorial/listing-02-03/src/main.rs:19}}
```
...
```rust
{{#include ../listings/ch02-guessing-game-tutorial/listing-02-04/src/main.rs:1:2}}
// ---snip---
```
...
```rust
{{#include ../listings/ch07-managing-growing-projects/listing-07-19/src/lib.rs}}
```
...
```rust
{{#include ../listings/ch07-managing-growing-projects/listing-07-20/src/lib.rs}}
```
