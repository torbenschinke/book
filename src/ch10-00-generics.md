...
```rust
{{#include ../listings/ch10-generic-types-traits-and-lifetimes/listing-10-01/src/main.rs:1:12}}
{{#include ../listings/ch10-generic-types-traits-and-lifetimes/listing-10-01/src/main.rs:14}}
```
...
```rust
{{#include ../listings/ch10-generic-types-traits-and-lifetimes/listing-10-02/src/main.rs}}
```
...
```rust
{{#include ../listings/ch10-generic-types-traits-and-lifetimes/listing-10-03/src/main.rs:1:17}}
{{#include ../listings/ch10-generic-types-traits-and-lifetimes/listing-10-03/src/main.rs:19:23}}
{{#include ../listings/ch10-generic-types-traits-and-lifetimes/listing-10-03/src/main.rs:25}}
```
