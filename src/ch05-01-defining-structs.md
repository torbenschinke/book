...
```rust
{{#include ../listings/ch05-using-structs-to-structure-related-data/listing-05-01/src/main.rs:1:6}}
```
...
```rust
{{#include ../listings/ch05-using-structs-to-structure-related-data/listing-05-02/src/main.rs:9:14}}
```
...
```rust
{{#include ../listings/ch05-using-structs-to-structure-related-data/listing-05-03/src/main.rs:9:16}}
```
...
```rust
{{#include ../listings/ch05-using-structs-to-structure-related-data/listing-05-04/src/main.rs:8:15}}
```
...
```rust
{{#include ../listings/ch05-using-structs-to-structure-related-data/listing-05-05/src/main.rs:8:15}}
```
...
```rust
{{#include ../listings/ch05-using-structs-to-structure-related-data/listing-05-06/src/main.rs:16:21}}
```
...
```rust
{{#include ../listings/ch05-using-structs-to-structure-related-data/listing-05-07/src/main.rs:16:20}}
```
...
```rust
{{#include ../listings/ch05-using-structs-to-structure-related-data/no-listing-01-tuple-structs/src/main.rs:2:6}}
```
...
> {{#include ../listings/ch05-using-structs-to-structure-related-data/no-listing-02-ownership-of-struct-data/src/main.rs:16:20}}
> ```
>
