...
{{#include ../listings/ch20-web-server/listing-20-23/src/lib.rs:60:68}}
```
...
```rust
{{#include ../listings/ch20-web-server/no-listing-04-update-worker-definition/src/lib.rs:70:73}}
```
...
```rust,ignore
{{#include ../listings/ch20-web-server/no-listing-05-fix-worker-new/src/lib.rs:75:76}}
        // --snip--

{{#include ../listings/ch20-web-server/no-listing-05-fix-worker-new/src/lib.rs:87:92}}
```
...
```rust,ignore
{{#include ../listings/ch20-web-server/no-listing-06-fix-threadpool-drop/src/lib.rs:60:70}}
```
...
```rust
{{#include ../listings/ch20-web-server/no-listing-07-define-message-enum/src/lib.rs:23:26}}
```
...
```rust,ignore
{{#include ../listings/ch20-web-server/listing-20-24/src/lib.rs:6:9}}

// --snip--

{{#include ../listings/ch20-web-server/listing-20-24/src/lib.rs:28}}
    // --snip--

{{#include ../listings/ch20-web-server/listing-20-24/src/lib.rs:55:63}}

// --snip--

{{#include ../listings/ch20-web-server/listing-20-24/src/lib.rs:82:110}}
```
...
```rust,ignore
{{#include ../listings/ch20-web-server/listing-20-25/src/lib.rs:65:83}}
```
...
```rust,ignore
{{#include ../listings/ch20-web-server/listing-20-26/src/bin/main.rs:9:22}}
```
...
```rust,ignore
{{#include ../listings/ch20-web-server/listing-20-26/src/bin/main.rs}}
```

<span class="filename">Filename: src/lib.rs</span>

```rust
{{#include ../listings/ch20-web-server/listing-20-26/src/lib.rs}}
```
