...
```rust
{{#include ../listings/ch19-advanced-features/listing-19-28/src/lib.rs}}
```
...
{{#include ../listings/ch19-advanced-features/listing-19-30/src/main.rs}}
```
...
```rust
{{#include ../listings/ch19-advanced-features/no-listing-20-impl-hellomacro-for-pancakes/hello_macro/src/lib.rs}}
```
...
```rust,ignore
{{#include ../listings/ch19-advanced-features/no-listing-20-impl-hellomacro-for-pancakes/pancakes/src/main.rs}}
```
...
```rust,ignore,does_not_compile
{{#include ../listings/ch19-advanced-features/listing-19-31/hello_macro/hello_macro_derive/src/lib.rs}}
```
...
```rust,ignore
{{#include ../listings/ch19-advanced-features/listing-19-33/hello_macro/hello_macro_derive/src/lib.rs:17:27}}
```
