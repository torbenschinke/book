...
```rust
{{#include ../listings/ch18-patterns-and-matching/no-listing-01-literals/src/main.rs:2:9}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/listing-18-11/src/main.rs:2:11}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/no-listing-02-multiple-patterns/src/main.rs:2:8}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/no-listing-03-ranges/src/main.rs:2:7}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/no-listing-04-ranges-of-char/src/main.rs:2:8}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/listing-18-12/src/main.rs}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/listing-18-13/src/main.rs}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/listing-18-14/src/main.rs}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/listing-18-15/src/main.rs}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/listing-18-16/src/main.rs}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/no-listing-05-destructuring-structs-and-tuples/src/main.rs:2:7}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/listing-18-17/src/main.rs}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/listing-18-18/src/main.rs:2:14}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/listing-18-19/src/main.rs:2:8}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/listing-18-20/src/main.rs}}
```
...
{{#include ../listings/ch18-patterns-and-matching/listing-18-21/src/main.rs:2:8}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/listing-18-22/src/main.rs:2:8}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/listing-18-23/src/main.rs:2:12}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/listing-18-24/src/main.rs}}
```
...
```rust,ignore,does_not_compile
{{#include ../listings/ch18-patterns-and-matching/listing-18-25/src/main.rs}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/listing-18-26/src/main.rs:2:8}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/listing-18-27/src/main.rs}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/listing-18-28/src/main.rs:2:8}}
```
...
```rust
{{#include ../listings/ch18-patterns-and-matching/listing-18-29/src/main.rs:2:18}}
```
