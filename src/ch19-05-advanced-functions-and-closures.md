...
```rust
{{#include ../listings/ch19-advanced-features/listing-19-27/src/main.rs}}
```
...
```rust
{{#include ../listings/ch19-advanced-features/no-listing-15-map-closure/src/main.rs:2:6}}
```
...
```rust
{{#include ../listings/ch19-advanced-features/no-listing-16-map-function/src/main.rs:2:6}}
```
...
```rust
{{#include ../listings/ch19-advanced-features/no-listing-17-map-initializer/src/main.rs:2:10}}
```
...
{{#include ../listings/ch19-advanced-features/no-listing-18-returns-closure/src/lib.rs}}
```
...
```rust
{{#include ../listings/ch19-advanced-features/no-listing-19-returns-closure-trait-object/src/lib.rs}}
```
